...
const Heart = (props: any) => (
    <svg {...props} viewBox="0 0 99 91" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function Footer() {
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            gsap.timeline()
                .from('.heart', { strokeDasharray: 500, strokeDashoffset: 1000 })
                .from('.heart', { strokeDasharray: 0, strokeDashoffset: 1000 })
        });
    ...
    return (
        <div className="footer min-w-screen min-h-screen font-futara bg-footer relative flex items-center justify-center">
            <h3 className="text-z48 lg:text-z32 md:text-z24 absolute top-1/4 lg:top-1/3 md:top-1/3 left-1/4 -translate-x-1/3">Hey there!</h3>
            <div
                className="
                    w-1/2 lg:w-3/4 md:w-5/6 min-h-1/2 p-4 text-z24 lg:text-z18 md:text-z16
