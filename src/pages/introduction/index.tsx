...
const A = ({ className }: { className: string }) => (
    <svg className={className} viewBox="0 0 195 160" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const U = ({ className }: { className: string }) => (
...
const O = ({ className }: { className: string }) => (
    <svg className={className} viewBox="0 0 82 160" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const G = ({ className }: { className: string }) => (
    <svg className={className} viewBox="0 0 86 94" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const S = ({ className }: { className: string }) => (
    <svg className={className} viewBox="0 0 110 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const G2 = ({ className }: { className: string }) => (
    <svg className={className} viewBox="0 0 115 98" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    ...
                    <h1 className={`${styles.name} hoverable iam relative tracking-wider font-bold select-none`}>
                        ...
                        <span className="relative">
                            <span className={`${styles.a} absolute xl:top-1 lg:-top-2 left-1/2`}>
                                <A className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            a
                        </span>
                        ng Ph
                        <span className="relative">
                            <span className={`${styles.u} absolute xl:top-1 lg:-top-2 left-1/2`}>
                                <U className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            u
                        </span>
                        <span className="relative">
                            <span className={`${styles.o} absolute xl:top-1 lg:-top-2 left-1/2`}>
                                <O className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            <span className={`${styles.s} absolute -top-12 left-1/2`}>
                                <S className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            o
                        </span>
                        c
                        Quan
                        <span className="relative">
                            <span className={`${styles.g} absolute bottom-9 -right-8 lg:bottom-5`}>
                                <G className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            <span className={`${styles.g} absolute top-0 -right-8 lg:-top-3`}>
                                <G2 className="xl:w-10 xl:h-10 lg:w-8 lg:h-8" />
                            </span>
                            g
                        </span>
                    </h1>
